...
app.get("/", (req, res) => {
  res.json({
    status: "success",
    message: "Welcome to the Classify API. Replace (jane) with any name of your choice Try https://hng-backend-task0-production.up.railway.app/api/classify?name=jane"
  });
});
